...
public class DefaultMQProducer extends ClientConfig implements MQProducer {
     ...
     *
     * @param producerGroup  Producer group, see the name-sake field.
     * @param enableMsgTrace Switch flag instance for message trace. 是否开启消息轨迹支持
     */
    ...
    /**
     * 从代码可以看到，核心思想是将一批消息（Collection msgs）打包为MessageBatch对象
     * 实际上RocketMQ在处理批量消息的时候是将其解析为单个消息再发送的，
     * 这样就在底层统一了单条消息、批量消息发送的逻辑，让整个框架的设计更加健壮
     *
     * @param msgs
     * @return
     * @throws MQClientException
